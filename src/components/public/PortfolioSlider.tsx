...
// We hardcode the categories to exactly match Vanibra's slider intent, 
// using high-quality Unsplash/Pexels architectural images.
const PORTFOLIO_ITEMS = [
  {
    title: 'Stucwerkzaamheden',
    img: `${P}/106399/pexels-photo-106399.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop`,
    link: '/projects',
  },
  {
    title: 'Schilderwerkzaamheden',
    img: `${P}/13067890/pexels-photo-13067890.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop`,
    link: '/projects',
  },
  {
    title: 'Renovatiewerkzaamheden',
    img: `${P}/5493654/pexels-photo-5493654.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop`,
    link: '/projects',
  },
  {
    title: 'Decoratief Stucwerk',
    img: `${P}/6434622/pexels-photo-6434622.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop`,
    link: '/projects',
  },
  {
    title: 'Buitenafwerking',
    img: `${P}/323780/pexels-photo-323780.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop`,
    link: '/projects',
  },
]

export default function PortfolioSlider({ lang }: { lang: Lang }) {
    ...
    <section id="portfolio-slider" style={{ background: 'var(--bg)', padding: '6rem 0 8rem', overflow: 'hidden' }}>
      ...
      <div className="rv" style={{ padding: '0 3.5rem', maxWidth: 1200, margin: '0 auto 3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '2rem' }}>
        <div>
          ...
          <h2 style={{ fontFamily: 'var(--font-archivo)', fontWeight: 700, fontSize: 'clamp(2rem,4vw,3.5rem)', lineHeight: 1.1, letterSpacing: '0.01em', color: 'var(--white)', margin: 0 }}>
            Onze <span style={{ color: 'var(--teal2)' }}>Diensten</span>
          </h2>
        </div>
      ...
      <div className="portfolio-track hide-scrollbar rv d1">
        {PORTFOLIO_ITEMS.map((item, idx) => (
          <Link key={idx} href={item.link} className="portfolio-card">
            <img src={item.img} alt={item.title} loading="lazy" className="portfolio-img" />
